...
namespace Odoo.Examples
{
    ...
    public class ComputedFieldDemo
    {
        ...
        public static void RunDemo()
        {
            ...
            Console.WriteLine(
                "            env.SetComputedValue(model, partner.Id, field, displayName);"
            );
            Console.WriteLine("        }");
            Console.WriteLine("    }");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine(
                "Note: DisplayName getter would trigger compute if NeedsRecompute is true."
            );
            ...
            Console.WriteLine(
                "  2. ComputeTracker marks DisplayName for recompute (depends on 'name')"
            );
            ...
            Console.WriteLine(
                "Note: Currently this triggers individual compute calls (lazy loading)."
            );
