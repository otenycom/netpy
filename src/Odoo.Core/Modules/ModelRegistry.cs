...
namespace Odoo.Core.Modules
{
    public class ModelRegistry
    {
        ...
        private readonly Dictionary<string, Func<IEnvironment, RecordId, IOdooRecord>> _factories;
        ...
        {
            _models = models;
            _factories = new Dictionary<string, Func<IEnvironment, RecordId, IOdooRecord>>();
        ...
        /// </summary>
        public IEnumerable<(int ModelToken, int FieldToken)> GetDependents(
            int modelToken,
            int fieldToken
        )
        {
